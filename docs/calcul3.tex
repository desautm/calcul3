...
\protect\hypertarget{thm:unnamed-chunk-179}{}{\label{thm:unnamed-chunk-179}
...
\StringTok{digraph schema_derivation \{}
...
\StringTok{  f->x f->y x->t y->t}
\StringTok{\}}
\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{calcul3_files/figure-latex/unnamed-chunk-181-1.pdf}
